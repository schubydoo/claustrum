...
> the always-on `-install` bounds and ordering (**D11** the 15 s runnability
> probe, **D12** the 5-minute download deadline, **D13** verify-before-decompress),
> and the CT-3 `claustrum.conf` file (`version-override` / `keep-children` /
