...
Those items are the numbered **deliberate divergences** (D1-D16) and the
...
**[DIVERGENCES.md](DIVERGENCES.md)**. The catalog holds D1-D16 and CT-1..CT-5.
